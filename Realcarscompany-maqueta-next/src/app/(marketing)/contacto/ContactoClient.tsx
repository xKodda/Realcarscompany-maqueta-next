                    ...
                    <div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <input
                                    type="text" id="nombre" name="nombre" value={formData.nombre} onChange={handleChange} onBlur={handleBlur} required maxLength={100}
                                    className={`w-full px-4 py-3 border transition-colors ${errors.nombre ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-[#802223]'} focus:outline-none`}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    type="email" id="email" name="email" value={formData.email} onChange={handleChange} onBlur={handleBlur} required maxLength={254}
                                    className={`w-full px-4 py-3 border transition-colors ${errors.email ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-[#802223]'} focus:outline-none`}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    type="tel" id="telefono" name="telefono" value={formData.telefono} onChange={handleChange} onBlur={handleBlur} required maxLength={15}
                                    className={`w-full px-4 py-3 border transition-colors ${errors.telefono ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-[#802223]'} focus:outline-none`}
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    id="mensaje" name="mensaje" value={formData.mensaje} onChange={handleChange} onBlur={handleBlur} required rows={6} maxLength={1000}
                                    className={`w-full px-4 py-3 border transition-colors resize-none ${errors.mensaje ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-[#802223]'} focus:outline-none`}
                                />
                            </div>
