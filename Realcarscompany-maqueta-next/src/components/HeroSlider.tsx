...
const slides: Slide[] = [
  ...
  },
  {
    id: 2,
    title: 'MONZZA',
    subtitle: 'Sorteo de la Moto Italiana',
    description:
      'Compra la imagen digital MONZZA y accede automáticamente a la promoción comercial por la MV Agusta TVF3 800 RC 2024',
    image: '/images/brand/banner1.png',
    badge: '¡Lanzamiento Oficial!',
    cta: {
      primary: { text: 'Adquirir Colección', href: '/monzza' },
      secondary: { text: 'Ver Galería', href: '/monzza' }
    }
  }
]
